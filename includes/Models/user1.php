...
class User1 extends DatabaseObject {
    
    //our database columns are attributes individually
    //database column variables
    protected static $table_name = "tenant";
    protected static $db_fields = array('id', 'name', 'occupation', 'phone_number', 'marrital_status', 'state_of_origin', 'email', 'password');
