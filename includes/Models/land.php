<?php
class Land extends DatabaseObject{
     //our database columns are attributes individually
    //database column variables
    protected static $table_name = "land_details";
    protected static $db_fields = array('id','land_id','outside', 'price','size', 'address','status');
