...
class UserHouse extends DatabaseObject {
    
    //our database columns are attributes individually
    //database column variables
    protected static $table_name = "apply_house";
    protected static $db_fields = array('id', 'name','gender', 'number','email', 'day', 'month','year', 'address', 'city', 'house_type', 'vacancy');
