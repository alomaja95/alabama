...
class Photograph extends DatabaseObject{
    ...
    protected static $table_name = "house_details";
    protected static $db_fields = array('id','house_id','outside','inside', 'within','price', 'address', 'house_type', 'number','status');
    
    public $id;
    public $house_id;
    public $outside= "uploads\images";
    public $inside = "uploads\images";
    public $within = "uploads\images";
    public $address;
    public $price;
    public $house_type;
    public $number;
