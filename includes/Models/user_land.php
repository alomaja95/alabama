...
class UserLand extends DatabaseObject {
    
    //our database columns are attributes individually
    //database column variables
    protected static $table_name = "apply_land";
    protected static $db_fields = array('id', 'name','gender', 'number','email', 'day', 'month','year', 'address', 'city', 'land_type', 'vacancy');
