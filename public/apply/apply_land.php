					...
					<ul class="field-list">
						...
						<li> 
							...
							<div class="form-input add">
								<span class="form-sub-label">
									<input type="text" name="address" placeholder="adrees of the land " required="require">
									<label class="form-sub-label1"> Street Address </label>
								</span>
								<span class="form-sub-label">
									<input type="text" name="city" placeholder="city where land is located" required= :"require">
						...
						<li class="last-type"> 
							<label class="form-label1">
								Select which types of land to register.
								<span class="form-required"> * </span>
							</label>
															<span class="form-sub-label">
									<select name="land">
										<option>&nbsp;</option>
										<option value="less plot"> less than plot</option>
										<option value="plot"> plot </option>
										<option value="less hectre">less than Hectre</option>
										<option value="hectre"> Hectre </option>
									 </select>
								</span>
								<span class="form-sub-label">
								<input type="text" name="vacancy" placeholder="Number Available"><br>
</span>
						</li>
					</ul>
