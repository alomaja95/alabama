...
$houses = Photograph::find_by_id($_GET['id']);
if(!$houses){
	...
	<div class="home1">
		...
		<div class="home1_slider_container">
			 ...
			 <div class="owl-carousel owl-theme home_slider">
			 	...
			 	<!-- Slide -->
			 	<div class="slide">
			 		<div class="background_image"><img src="<?php echo $houses->inside; ?>" style="height:600px" ></div>

			 	</div>

			 	<!-- Slide -->
			 	<div class="slide">
			 		<div class="background_image"><img src="<?php echo $houses->outside; ?>" style="height:600px"></div>

			 	</div>

			 	<!-- Slide -->
			 	<div class="slide">
			 		<div class="background_image"><img src="<?php echo $houses->within; ?>" style="height:600px"></div>
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="property_info">
									<div class="tag_price listing_price">&#8358; <?php echo $houses->price; ?></div>
									...
									<div class="listing_location d-flex flex-row align-items-start justify-content-start">
										...
										<span><?php echo $houses->address; ?></span>
									</div>
									<div class="listing_list">
										<ul>
											<li>Property ID: <?php echo $houses->house_id; ?></li>
